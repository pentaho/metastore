...
public class DelegatingMetastoreTest {
  ...
  public void testDelegatingMetaStoreHasNullActiveAfterMultiArgConstruction() throws MetaStoreException {
    DelegatingMetaStore delegatingMetaStore = new DelegatingMetaStore(mock(IMetaStore.class), mock(IMetaStore.class));
    assertNull(delegatingMetaStore.getActiveMetaStore());
  }
  ...
  public void testDelegatingMetaStoreSetActive() throws MetaStoreException {
    ...
    DelegatingMetaStore delegatingMetaStore = new DelegatingMetaStore(getMockMetaStoreWithName("inactive_1"),
        newActiveMetaStore, getMockMetaStoreWithName("inactive_2"));
  ...
  public void testRemoveMetaStoreObjectRemovesMetaStore() throws MetaStoreException {
    ...
    IMetaStore newMetaStore = getMockMetaStoreWithName(newName);
    DelegatingMetaStore delegatingMetaStore = new DelegatingMetaStore(getMockMetaStoreWithName("inactive_1"),
        newMetaStore, getMockMetaStoreWithName("inactive_2"));
    assertEquals(3, delegatingMetaStore.getMetaStoreList().size());
  ...
  public void testNamespaceExistsReturnsFalseWithActiveAndFalse() throws MetaStoreException {
    ...
    IMetaStore newMetaStore = getMockMetaStoreWithName(newName);
    when(newMetaStore.namespaceExists(testNamespace)).thenReturn(true);
    DelegatingMetaStore delegatingMetaStore = new DelegatingMetaStore(getMockMetaStoreWithName(inactiveName),
        newMetaStore, getMockMetaStoreWithName("inactive_2"));
  ...
  public void testCreateNamespaceThrowsExceptionIfNoActive() throws MetaStoreException {
    ...
    DelegatingMetaStore delegatingMetaStore = new DelegatingMetaStore(getMockMetaStoreWithName(inactiveName1),
        getMockMetaStoreWithName(inactiveName2));
  ...
  public void testCreateNamespaceOnlyCreatesNamespaceInActiveMetaStore() throws MetaStoreException {
    ...
    DelegatingMetaStore delegatingMetaStore = new DelegatingMetaStore(inactiveMetaStore1, activeMetaStore,
        inactiveMetaStore2);
    delegatingMetaStore.setActiveMetaStoreName(activeName);
    delegatingMetaStore.createNamespace(testNamespace);
  ...
  public void testGetElementTypesReturnsAllIfNoActive() throws MetaStoreException {
    ...
    final List<IMetaStoreElementType> inactive1ElementTypes = Arrays.asList(inactiveElementType1, inactiveElementType2);
    final List<IMetaStoreElementType> inactive2ElementTypes = Arrays.asList(inactiveElementType3, inactiveElementType4);
  ...
  public void testGetElementTypeByNameReturnsTypeIfNoActive() throws MetaStoreException {
    ...
    DelegatingMetaStore delegatingMetaStore = new DelegatingMetaStore(inactiveMetaStore1, inactiveMetaStore2);
    assertEquals(inactiveElementType1,
        delegatingMetaStore.getElementTypeByName(testNamespace, inactiveElementType1.getName()));
    assertEquals(inactiveElementType2,
        delegatingMetaStore.getElementTypeByName(testNamespace, inactiveElementType2.getName()));
    assertEquals(inactiveElementType3,
        delegatingMetaStore.getElementTypeByName(testNamespace, inactiveElementType3.getName()));
    assertEquals(inactiveElementType4,
        delegatingMetaStore.getElementTypeByName(testNamespace, inactiveElementType4.getName()));
  }
  ...
  public void testGetElementTypeByNameReturnsActiveTypesIfMetaStoreIsActive() throws MetaStoreException {
    ...
    DelegatingMetaStore delegatingMetaStore = new DelegatingMetaStore(activeMetaStore, inactiveMetaStore);
    delegatingMetaStore.setActiveMetaStoreName(activeName);
    assertEquals(activeElementType1,
        delegatingMetaStore.getElementTypeByName(testNamespace, activeElementType1.getName()));
    assertEquals(activeElementType2,
        delegatingMetaStore.getElementTypeByName(testNamespace, activeElementType2.getName()));
  ...
  public void testGetElementIdsReturnsAllIfNoActive() throws MetaStoreException {
    ...
    assertFalse(containsAny(Arrays.asList(inactiveElementId1, inactiveElementId2, inactiveElementId3), elementsType2));
  }
  ...
  public void testGetElementReturnsAllIfNoActive() throws MetaStoreException {
    ...
    DelegatingMetaStore delegatingMetaStore = new DelegatingMetaStore(inactiveMetaStore1, inactiveMetaStore2);
    assertEquals(inactiveElement1,
        delegatingMetaStore.getElement(testNamespace, inactiveElementType1, inactiveElementName1));
    assertEquals(inactiveElement2,
        delegatingMetaStore.getElement(testNamespace, inactiveElementType1, inactiveElementName2));
    assertEquals(inactiveElement3,
        delegatingMetaStore.getElement(testNamespace, inactiveElementType1, inactiveElementName3));
    assertEquals(inactiveElement4,
        delegatingMetaStore.getElement(testNamespace, inactiveElementType2, inactiveElementName4));
  }
  ...
  public void testGetElementByNameReturnsAllIfNoActive() throws MetaStoreException {
    ...
    DelegatingMetaStore delegatingMetaStore = new DelegatingMetaStore(inactiveMetaStore1, inactiveMetaStore2);
    assertEquals(inactiveElement1,
        delegatingMetaStore.getElementByName(testNamespace, inactiveElementType1, inactiveElementName1));
    assertEquals(inactiveElement2,
        delegatingMetaStore.getElementByName(testNamespace, inactiveElementType1, inactiveElementName2));
    assertEquals(inactiveElement3,
        delegatingMetaStore.getElementByName(testNamespace, inactiveElementType1, inactiveElementName3));
    assertEquals(inactiveElement4,
        delegatingMetaStore.getElementByName(testNamespace, inactiveElementType2, inactiveElementName4));
  }
  ...
  public void testNewElementWithArgsOnlyCreatesNewElementInActiveMetaStore() throws MetaStoreException {
    ...
    verify(inactiveMetaStore1, never()).newElement(any(IMetaStoreElementType.class), anyString(), any(Object.class));
    verify(inactiveMetaStore2, never()).newElement(any(IMetaStoreElementType.class), anyString(), any(Object.class));
  }
